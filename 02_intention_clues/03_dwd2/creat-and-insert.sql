create database zh_dwd;

create table zh_dwd.itcast_clue_dwd(
    id                          string,
...
drop table zh_dwd.itcast_clue_dwd;

insert into zh_dwd.itcast_clue_dwd
select
       cr.id,
       cr.create_date_time       ,
       cr.update_date_time       ,
...
from zh_ods.scrm_customer_relationship cr right join zh_ods.scrm_customer_clue cc
